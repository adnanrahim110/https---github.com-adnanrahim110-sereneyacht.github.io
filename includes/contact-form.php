<section class="cu-sec-3" id="booking">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-5">
        <div class="cus3-text">
          <div class="ednp-head w-100 position-relative top-0">
        ...
        <div class="cus3-form">
          <form action="config/mail.php" method="post">
            ...
            <div class="g-recaptcha" data-sitekey="6LfgyEwqAAAAACyPfzjNsJDby8GQy49AwLBlOCNx"></div>

            <div class="sdc-submit col-12">
      ...
      <div class="col-12 col-lg-7">
        <div class="cus3-img">
          <img src="assets/images/marya/marya-img7.jpg" alt="">
        </div>
      </div>
    </div>
  </div>
