...
<body class="overflow-x-hidden">
    ...
    <main class="position-relative z-0 overflow-x-hidden">
        <section class="hero-sec overflow-x-hidden">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img src="assets/images/Banner-4.jpg" alt="Image 3">
                    </div>
                    <div class="swiper-slide">
                        <img src="assets/images/Banner-5.jpg" alt="Image 3">
                    </div>
                </div>
                <div class="slider-counter">
                    <svg width="100px" height="100px" viewBox="0 0 42 42" class="spinner js-spinner">
                        <circle class="spinner-ring" cx="21" cy="21" r="15.91549430918954" fill="transparent"
                            stroke="#d2d3d4" stroke-width="3"></circle>
                        <circle class="spinner-segment" cx="21" cy="21" r="15.91549430918954" fill="transparent"
                            stroke="#ce4b99" stroke-width="3" stroke-dasharray="85 15" stroke-dashoffset="0"></circle>
                    </svg>
        ...
        <section class="available-sec">
            <div class="container">
                <form action="config/mail.php" id="reservation-form" method="post" class="as-form">
                    <div class="row align-items-end justify-content-center">
                        <div class="col-12 col-sm-6 col-md-4 col-lg-2">
                            <div class="form-group">
                                <label for="boat">Boat:</label>
                                <div class="input-group as-inputs">
                                    <div class="select-container">
                                        <select name="boat_id" id="boat" class="guest-select">
                                            <?php
                                            $result = $con->query("SELECT id, name FROM yachts");
                                            if ($result->num_rows > 0) {
                                                while ($drop_row = $result->fetch_assoc()) {
                                            ?>
                                                    <option value="<?= $drop_row['name'] ?>">
                                                        <?= $drop_row['name'] ?>
                                                    </option>
                                            <?php
                                                }
                                            } else {
                                                echo '<option value="" selected class="bg-warning">No Boat</option>';
                                            }
                                            ?>
                                        </select>
                                    </div>
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-2 ">
                            <div class="form-group">
                                ...
                                <div class="input-group as-inputs">
                                    <input type="text" id="check-in" name="check_in" class="datepicker form-control"
                                        value="today">
                        ...
                        <div class="col-6 col-sm-4 col-md-4 col-lg-2 ">
                            <label for="check-out">From:</label>
                            <div class="input-group as-inputs">
                                <select id="time-select-from" name="time_from" class="form-control"></select>
                                <span><ion-icon name="time-outline"></ion-icon></span>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-4 col-lg-2 mt-0 mt-md-3 mt-lg-0">
                            <label for="check-out">To:</label>
                            <div class="input-group as-inputs">
                                <select id="time-select-to" name="time_to" class="form-control"></select>
                                <span><ion-icon name="time-outline"></ion-icon></span>
                            </div>
                        </div>
                        <div class="col-6 col-sm-4 col-md-4 col-lg-2 mt-0 mt-md-3 mt-lg-0">
                        ...
                        <div class=" col-md-4 col-lg-2 mt-0 mt-md-3 mt-xl-0">
                            <div class="as-btn" id="submit-btn">
                                    ...
                                    <div class="ytv-product_footer">
                                        <div class="ytv-product_prices">
                                            <div class="ytv-product_price">
                                                ...
                                                <div class="ytv-product_price-val"> AED <?= $row['price_per_hour'] ?> <span>+ 5%
                                                        VAT</span></div>
                                            </div>
                                        </div>
                                        <div class="ytv-product_form">
                                            <a href="tel:+971505653215" class="ytv-product_phone-btn">
            ...
            <div class="container ednp-wrapper">
                <div class="row">
                    ...
                    <div class="col-12 col-md-12 col-lg-12">
                        <div class="ednp-map">
                            <img src="assets/images/ednp-map1.png" alt="" class="opacity-75">
                            <div class="ednp-map-overlay">
                                <div class="ednp-map-overlay-inner">
                                    <span class="ednap-map-loc cuba-text">DUbai Harbour</span>
                                    <div class="ednp-img cuba">
                                        <img src="assets/images/dubai-harbour.jpg" alt="">
                                    </div>
                                    <div class="ednp-line line">
                                        <img src="assets/images/Line1.png" alt="">
                                    </div>
                                    <span class="ednap-map-loc bahamas-text">Dubai Canal</span>
                                    <div class="ednp-img bahamas">
                                        <img src="assets/images/dubai-canal.jpg" alt="">
                                    </div>
                                    <!-- <span class="dot dot-1"></span> -->
                                    <span class="ednap-map-loc dominian-text">The Palm</span>
                                            ...
                                            <div class="pricing-card">
                                                <div class="pricing-card-item">
                                                    <div class="card-header">
                                                        <img src="assets/images/marya/marya-bg.jpg" alt="">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="pkg-name">
                                                            <h1 class="card-title">50 ft Luxury Yacht</h1>
                                                        ...
                                                        <div class="card-content">
                                                            ...
                                                            <ul class="pkg-config">
                                                                ...
                                                                <li class="pkg-cnfg_item">
                                                                    <span><ion-icon name="balloon-outline"></ion-icon></span>
                                                                    Balloons
                                                                </li>
                                                                <li class="pkg-cnfg_item">
                                                                ...
                                                                <li class="pkg-cnfg_item">
                                                                    <span><ion-icon name="wine-outline"></ion-icon></span>
                                                                    Soft Drinks
                                                                </li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <div class="pricing-card-item">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="pkg-name">
                                                            <h1 class="card-title">50 ft Luxury Yacht</h1>
                                                            <a href="#" class="sub-title-card">
                                                                <span>(Anniversary Package)</span>
                                                            </a>
                                                        </div>
                                                        <div class="card-content">
                                                            <h3 class="pkg-price">
                                                                <span class="money">
                                                                    <img src="assets/images/icons8-money-bill-96.png"
                                                                        alt="" class="img-fluid">
                                                                </span>
                                                                <p class="m-0">
                                                            ...
                                                            <ul class="pkg-config">
                                                                ...
                                                                <li class="pkg-cnfg_item">
                                                                    <span><ion-icon
                                                                            name="balloon-outline"></ion-icon></span>
                                                                    Balloons
                                                                </li>
                                                                <li class="pkg-cnfg_item">
                                                                    <span><i
                                                                ...
                                                                <li class="pkg-cnfg_item">
                                                                    <span><ion-icon
                                                                            name="wine-outline"></ion-icon></span>
                                                                    Fresh Juices
                                                                </li>
                                                            </ul>
                                                        </div>
                                                ...
                                                <div class="pricing-card-item">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="pkg-name">
                                                            <h1 class="card-title">50 ft Luxury Yacht</h1>
                                                            <a href="#" class="sub-title-card">
                                                                <span>(2 hour Live BBQ Dinner)</span>
                                                            </a>
                                                        </div>
                                                        <div class="card-content">
                                                            <h3 class="pkg-price">
                                                            ...
                                                            <ul class="pkg-config">
                                                                ...
                                                                <li class="pkg-cnfg_item">
                                                                    <span><ion-icon
                                                                            name="rose-outline"></ion-icon></span>
                                                                    Bouquet of Roses
                                                                </li>
                                                            </ul>
                                                        </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            flatpickr("#check-in", {
                ...
                onChange: function(selectedDates, dateStr, instance) {
                    // Custom behavior if needed when date changes
                }
            });
        });
        document.addEventListener('DOMContentLoaded', function() {
            const timeSelectFrom = document.getElementById('time-select-from');
            const timeSelectTo = document.getElementById('time-select-to');
            ...
            function generateTimeOptions(selectElement, startHour = 0, startMinute = 0) {
                ...
                for (let hour = startHour; hour < 24; hour++) {
                    ...
                    startMinute = 0; // Reset startMinute for subsequent hours
                }
            }
            ...
            function updateToOptions() {
                ...
                generateTimeOptions(timeSelectTo, fromHour, fromMinute + 30);
            }

            // Generate initial options
            generateTimeOptions(timeSelectFrom);
            generateTimeOptions(timeSelectTo);

            // Update "To" options based on "From" selection
            timeSelectFrom.addEventListener('change', updateToOptions);
        });
    </script>
    <!-- Form Submition -->
    <script>
